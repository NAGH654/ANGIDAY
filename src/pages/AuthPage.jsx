...
const AuthPage = () => {
  ...
  const ForgotPasswordView = () => (
    <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md z-10 transition-all duration-300">
      ...
      <div className="mb-6">
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-12 py-3 text-sm text-gray-700 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
          />
          <svg className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <button
        ...
        className="w-full bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 text-white font-semibold py-3 rounded-lg flex items-center justify-center hover:shadow-lg transition-shadow duration-300 mb-6"
      >
        Send Reset Link
      ...
      <button
        ...
        className="w-full flex items-center justify-center text-gray-600 hover:text-gray-800 transition-colors duration-200 mb-8"
      >
  ...
  const MainAuthView = () => (
    <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md z-10 transition-all duration-300">
      ...
      <p className="text-center text-gray-500 mb-6">
        {isSignUp ? 'Join thousands of food lovers today' : 'Sign in to continue your culinary journey'}
      </p>
      ...
      <div>
        ...
        {isSignUp && (
          <div className="mb-4 relative animate-fadeIn">
            ...
            {/* Phone Icon */}
            <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.211-.998-.58-1.35l-3.952-3.952a1.125 1.125 0 00-1.591 0L14.25 10.5l-4.243-4.243 1.23-1.23a1.125 1.125 0 000-1.591L7.35 1.58a2.25 2.25 0 00-1.35-.58H3.75A2.25 2.25 0 001.5 3.375v1.5a2.25 2.25 0 002.25 2.25z" />
            </svg>
          </div>
        )}
        ...
        {/* Bottom section for Sign In vs Sign Up */}
        {!isSignUp ? (
          ...
          <div className="flex items-center mb-6 text-sm">
            <input type="checkbox" id="terms" className="w-4 h-4 text-pink-600 bg-gray-100 border-gray-300 rounded focus:ring-pink-500"/>
            <label htmlFor="terms" className="ml-2 text-gray-600">
              I agree to the <button className="text-pink-500 font-semibold hover:text-pink-600">Terms of Service</button> and <button className="text-pink-500 font-semibold hover:text-pink-600">Privacy Policy</button>
            </label>
          </div>
        )}
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 text-white font-semibold py-3 rounded-lg flex items-center justify-center hover:shadow-lg transition-shadow duration-300"
        >
      ...
      <div className="flex gap-4">
        <button className="w-1/2 flex items-center justify-center py-2.5 border border-gray-300 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors duration-200">
          {/* Google Icon */}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-pink-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {currentView === 'forgot' ? <ForgotPasswordView /> : <MainAuthView />}
