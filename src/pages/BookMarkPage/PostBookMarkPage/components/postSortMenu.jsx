...
const OPTIONS = [
  ...
  { key: "recent", label: "Mới lưu" },
  { key: "likes", label: "Nhiều lượt thích" },
  { key: "comments", label: "Nhiều bình luận" },
  { key: "shares", label: "Nhiều chia sẻ" },
];

const PostSortMenu = ({ sortBy, setSortBy }) => {
            ...
            {OPTIONS.map((o) => (
              <button
                ...
                className={`w-full text-left px-3.5 py-2.5 text-sm transition ${
                  o.key === sortBy ? "bg-pink-50 text-pink-700" : "hover:bg-gray-50 text-gray-700"
                }`}
              >
                {o.label}
              </button>
...
export default React.memo(PostSortMenu);
