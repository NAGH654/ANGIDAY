  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-pink-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md z-10">
        ...
        <p className="text-center text-gray-500 mb-6">Join thousands of food lovers today</p>

        <div className="bg-gray-100 rounded-lg p-1 flex justify-between mb-6">
          <button className="w-1/2 py-2 text-sm font-semibold text-gray-500">Sign In</button>
          <button className="w-1/2 bg-white rounded-md py-2 text-sm font-semibold text-gray-800 shadow">Sign Up</button>
        </div>
        ...
        <form>
          ...
          <div className="flex items-center mb-6 text-sm">
            ...
            <label htmlFor="remember" className="ml-2 text-gray-600">I agree to the <a href="#" className="text-pink-500 font-semibold">Terms of Service</a> and <a href="#" className="text-pink-500 font-semibold">Privacy Policy</a></label>
          </div>
